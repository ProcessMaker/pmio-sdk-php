 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class MetaLog implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'MetaLog';
    ...
    {
        $this->container['import_log'] = isset($data['import_log']) ? $data['import_log'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['import_log'] === null) {
            $invalid_properties[] = "'import_log' can't be null";
        }
    ...
    {
        return $this->container['import_log'];
    }

    /**
     * Sets import_log
     * @param string $import_log
     * @return $this
     */
    public function setImportLog($import_log)
    {
        $this->container['import_log'] = $import_log;
