...
class Gateway implements ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Gateway';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\GatewayAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'gateway';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\GatewayAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\GatewayAttributes $attributes
     * @return $this
     */
