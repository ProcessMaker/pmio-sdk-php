 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InputOutput implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'InputOutput';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\InputOutputAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'input_output';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\InputOutputAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\InputOutputAttributes $attributes
     * @return $this
     */
