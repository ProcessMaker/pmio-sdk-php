...
/**
 * InputOutputAttributes Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     ProcessMaker\PMIO
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InputOutputAttributes implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'InputOutput_attributes';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['input_parameters'] === null) {
            $invalid_properties[] = "'input_parameters' can't be null";
        }
        if ($this->container['output_parameters'] === null) {
            $invalid_properties[] = "'output_parameters' can't be null";
        }
