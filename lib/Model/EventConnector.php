...
/**
 * EventConnector Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     ProcessMaker\PMIO
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EventConnector implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'EventConnector';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\EventConnectorAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'event_connector';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\EventConnectorAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\EventConnectorAttributes $attributes
     * @return $this
     */
