...
/**
 * TaskConnector Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     ProcessMaker\PMIO
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TaskConnector implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'TaskConnector';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\TaskConnectorAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'task_connector';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\TaskConnectorAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\TaskConnectorAttributes $attributes
     * @return $this
     */
