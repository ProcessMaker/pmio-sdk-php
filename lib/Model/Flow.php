...
class Flow implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\FlowAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'flow';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\FlowAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\FlowAttributes $attributes
     * @return $this
     */
