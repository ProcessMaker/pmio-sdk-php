 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BpmnFile implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'BpmnFile';
    ...
    protected static $swaggerTypes = array(
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\BpmnFileAttributes'
    );
    ...
    {
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'process';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\BpmnFileAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\BpmnFileAttributes $attributes
     * @return $this
     */
