...
class OauthClient implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'id' => 'int',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\OauthClientAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'client';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\OauthClientAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\OauthClientAttributes $attributes
     * @return $this
     */
