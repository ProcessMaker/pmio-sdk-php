...
class Instance implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\InstanceAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'instance';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\InstanceAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\InstanceAttributes $attributes
     * @return $this
     */
