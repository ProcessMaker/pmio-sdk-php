...
class Task implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\TaskAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'task';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\TaskAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\TaskAttributes $attributes
     * @return $this
     */
