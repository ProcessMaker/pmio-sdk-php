...
class Event implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\EventAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'event';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\EventAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\EventAttributes $attributes
     * @return $this
     */
