...
/**
 * DataModelItem Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     ProcessMaker\PMIO
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DataModelItem implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'DataModelItem';
    ...
    protected static $swaggerTypes = array(
        'id' => 'string',
        'type' => 'string',
        'attributes' => '\ProcessMaker\PMIO\Model\DataModelItemAttributes'
    );
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['type'] = isset($data['type']) ? $data['type'] : 'data_model';
    ...
    /**
     * Gets attributes
     * @return \ProcessMaker\PMIO\Model\DataModelItemAttributes
     */
    ...
    /**
     * Sets attributes
     * @param \ProcessMaker\PMIO\Model\DataModelItemAttributes $attributes
     * @return $this
     */
