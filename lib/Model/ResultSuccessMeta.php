...
/**
 * ResultSuccessMeta Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     ProcessMaker\PMIO
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ResultSuccessMeta implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'ResultSuccess_meta';
    ...
    /**
     * Sets code
     * @param string $code Result code from ApiCodes dictionary
     * @return $this
     */
    ...
    /**
     * Sets title
     * @param string $title Result textual explanation
     * @return $this
     */
