...
/**
 * GroupCollection Class Doc Comment
 *
 * @category    Class */
...
class GroupCollection implements ArrayAccess
{
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GroupCollection';
    ...
    protected static $swaggerTypes = array(
        'data' => '\ProcessMaker\PMIO\Model\Group[]',
    ...
    /**
     * Gets data
     * @return \ProcessMaker\PMIO\Model\Group[]
     */
    ...
    /**
     * Sets data
     * @param \ProcessMaker\PMIO\Model\Group[] $data
     * @return $this
     */
