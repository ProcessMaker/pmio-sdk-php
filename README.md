...
- Build date: 2017-09-26T12:29:59.921+03:00
...
*Client* | [**findTokens**](docs/Api/Client.md#findtokens) | **GET** /processes/{process_id}/instances/{instance_id}/tokens | 
...
*Event* | [**addEvent**](docs/Api/Event.md#addevent) | **POST** /processes/{process_id}/events | 
*Event* | [**addEventConnector**](docs/Api/Event.md#addeventconnector) | **POST** /processes/{process_id}/events/{event_id}/connectors | 
*Event* | [**deleteEvent**](docs/Api/Event.md#deleteevent) | **DELETE** /processes/{process_id}/events/{event_id} | 
*Event* | [**deleteEventConnector**](docs/Api/Event.md#deleteeventconnector) | **DELETE** /processes/{process_id}/events/{event_id}/connectors/{connector_id} | 
*Event* | [**eventTrigger**](docs/Api/Event.md#eventtrigger) | **POST** /processes/{process_id}/events/{event_id}/trigger | 
*Event* | [**eventWebhook**](docs/Api/Event.md#eventwebhook) | **POST** /processes/{process_id}/events/{event_id}/webhook | 
*Event* | [**findEventById**](docs/Api/Event.md#findeventbyid) | **GET** /processes/{process_id}/events/{event_id} | 
*Event* | [**findEventConnectorById**](docs/Api/Event.md#findeventconnectorbyid) | **GET** /processes/{process_id}/events/{event_id}/connectors/{connector_id} | 
*Event* | [**findEventConnectors**](docs/Api/Event.md#findeventconnectors) | **GET** /processes/{process_id}/events/{event_id}/connectors | 
*Event* | [**findEvents**](docs/Api/Event.md#findevents) | **GET** /processes/{process_id}/events | 
*Event* | [**updateEvent**](docs/Api/Event.md#updateevent) | **PUT** /processes/{process_id}/events/{event_id} | 
*Event* | [**updateEventConnector**](docs/Api/Event.md#updateeventconnector) | **PUT** /processes/{process_id}/events/{event_id}/connectors/{connector_id} | 
*Flow* | [**addFlow**](docs/Api/Flow.md#addflow) | **POST** /processes/{process_id}/flows | 
*Flow* | [**deleteFlow**](docs/Api/Flow.md#deleteflow) | **DELETE** /processes/{process_id}/flows/{flow_id} | 
*Flow* | [**findFlowById**](docs/Api/Flow.md#findflowbyid) | **GET** /processes/{process_id}/flows/{flow_id} | 
*Flow* | [**findFlows**](docs/Api/Flow.md#findflows) | **GET** /processes/{process_id}/flows | 
*Flow* | [**updateFlow**](docs/Api/Flow.md#updateflow) | **PUT** /processes/{process_id}/flows/{flow_id} | 
*Gateway* | [**addGateway**](docs/Api/Gateway.md#addgateway) | **POST** /processes/{process_id}/gateways | 
*Gateway* | [**deleteGateway**](docs/Api/Gateway.md#deletegateway) | **DELETE** /processes/{process_id}/gateways/{gateway_id} | 
*Gateway* | [**findGatewayById**](docs/Api/Gateway.md#findgatewaybyid) | **GET** /processes/{process_id}/gateways/{gateway_id} | 
*Gateway* | [**findGateways**](docs/Api/Gateway.md#findgateways) | **GET** /processes/{process_id}/gateways | 
*Gateway* | [**updateGateway**](docs/Api/Gateway.md#updategateway) | **PUT** /processes/{process_id}/gateways/{gateway_id} | 
...
*Process* | [**addProcess**](docs/Api/Process.md#addprocess) | **POST** /processes | 
*Process* | [**deleteProcess**](docs/Api/Process.md#deleteprocess) | **DELETE** /processes/{id} | 
*Process* | [**findProcessById**](docs/Api/Process.md#findprocessbyid) | **GET** /processes/{id} | 
*Process* | [**findProcesses**](docs/Api/Process.md#findprocesses) | **GET** /processes | 
*Process* | [**importBpmnFile**](docs/Api/Process.md#importbpmnfile) | **POST** /processes/import | 
*Process* | [**updateProcess**](docs/Api/Process.md#updateprocess) | **PUT** /processes/{id} | 
*ProcessInstance* | [**addInstance**](docs/Api/ProcessInstance.md#addinstance) | **POST** /processes/{process_id}/instances | 
*ProcessInstance* | [**deleteInstance**](docs/Api/ProcessInstance.md#deleteinstance) | **DELETE** /processes/{process_id}/instances/{instance_id} | 
*ProcessInstance* | [**findByFieldInsideDataModel**](docs/Api/ProcessInstance.md#findbyfieldinsidedatamodel) | **GET** /processes/{process_id}/datamodels/search/{search_param} | 
*ProcessInstance* | [**findDataModel**](docs/Api/ProcessInstance.md#finddatamodel) | **GET** /processes/{process_id}/instances/{instance_id}/datamodel | 
*ProcessInstance* | [**findInstanceById**](docs/Api/ProcessInstance.md#findinstancebyid) | **GET** /processes/{process_id}/instances/{instance_id} | 
*ProcessInstance* | [**findInstances**](docs/Api/ProcessInstance.md#findinstances) | **GET** /processes/{process_id}/instances | 
*ProcessInstance* | [**findTaskInstancesByInstanceAndTaskId**](docs/Api/ProcessInstance.md#findtaskinstancesbyinstanceandtaskid) | **GET** /instances/{instance_id}/tasks/{task_id}/task_instances | 
*ProcessInstance* | [**findTaskInstancesByInstanceAndTaskIdDelegated**](docs/Api/ProcessInstance.md#findtaskinstancesbyinstanceandtaskiddelegated) | **GET** /instances/{instance_id}/tasks/{task_id}/task_instances/delegated | 
*ProcessInstance* | [**findTaskInstancesByInstanceAndTaskIdStarted**](docs/Api/ProcessInstance.md#findtaskinstancesbyinstanceandtaskidstarted) | **GET** /instances/{instance_id}/tasks/{task_id}/task_instances/started | 
*ProcessInstance* | [**findTokens**](docs/Api/ProcessInstance.md#findtokens) | **GET** /processes/{process_id}/instances/{instance_id}/tokens | 
*ProcessInstance* | [**updateInstance**](docs/Api/ProcessInstance.md#updateinstance) | **PUT** /processes/{process_id}/instances/{instance_id} | 
*Task* | [**addGroupsToTask**](docs/Api/Task.md#addgroupstotask) | **PUT** /processes/{process_id}/tasks/{task_id}/groups | 
*Task* | [**addTask**](docs/Api/Task.md#addtask) | **POST** /processes/{process_id}/tasks | 
*Task* | [**addTaskConnector**](docs/Api/Task.md#addtaskconnector) | **POST** /processes/{process_id}/tasks/{task_id}/connectors | 
*Task* | [**deleteTask**](docs/Api/Task.md#deletetask) | **DELETE** /processes/{process_id}/tasks/{task_id} | 
*Task* | [**deleteTaskConnector**](docs/Api/Task.md#deletetaskconnector) | **DELETE** /processes/{process_id}/tasks/{task_id}/connectors/{connector_id} | 
*Task* | [**findTaskById**](docs/Api/Task.md#findtaskbyid) | **GET** /processes/{process_id}/tasks/{task_id} | 
*Task* | [**findTaskConnectorById**](docs/Api/Task.md#findtaskconnectorbyid) | **GET** /processes/{process_id}/tasks/{task_id}/connectors/{connector_id} | 
*Task* | [**findTaskConnectors**](docs/Api/Task.md#findtaskconnectors) | **GET** /processes/{process_id}/tasks/{task_id}/connectors | 
*Task* | [**findTaskInstanceById**](docs/Api/Task.md#findtaskinstancebyid) | **GET** /task_instances/{task_instance_id} | 
*Task* | [**findTaskInstances**](docs/Api/Task.md#findtaskinstances) | **GET** /task_instances | 
*Task* | [**findTasks**](docs/Api/Task.md#findtasks) | **GET** /processes/{process_id}/tasks | 
*Task* | [**removeGroupsFromTask**](docs/Api/Task.md#removegroupsfromtask) | **DELETE** /processes/{process_id}/tasks/{task_id}/groups | 
*Task* | [**syncGroupsToTask**](docs/Api/Task.md#syncgroupstotask) | **POST** /processes/{process_id}/tasks/{task_id}/groups | 
*Task* | [**updateTask**](docs/Api/Task.md#updatetask) | **PUT** /processes/{process_id}/tasks/{task_id} | 
*Task* | [**updateTaskConnector**](docs/Api/Task.md#updatetaskconnector) | **PUT** /processes/{process_id}/tasks/{task_id}/connectors/{connector_id} | 
*Task* | [**updateTaskInstance**](docs/Api/Task.md#updatetaskinstance) | **PATCH** /task_instances/{task_instance_id} | 
